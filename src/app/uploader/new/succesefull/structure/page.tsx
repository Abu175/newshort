...
export default function Component() {
  const [posts, setPosts] = useState([
    { title: 'The Future of AI', author: 'John Doe', status: 'Published', views: '1,234', engagement: '8.7%' },
    { title: 'Web3 Explained', author: 'Jane Smith', status: 'Draft', views: '987', engagement: '6.2%' },
  ])
...
//in htis file i try touplaod  video and its uplaodvideosucessfully 
...
const Webllix: React.FC = () => {
  ...
  const SendImage = useCallback(async () => {
    ...
    try {
      ...
      // Extract HTML code from the response if needed
      const htmlCode = extractHtmlCode(generatedCode);

      setImageGenerated(true); // Set the generated state to true

      // Redirect to the CodePreview component with the generated code after a short delay
      setTimeout(() => {
...
//its cchecked  when i generated code  its send the code to code precview newest and not hidding iamge in this 
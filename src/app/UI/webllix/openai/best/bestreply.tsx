...
const Webllix: React.FC = () => {
  ...
  const SendImage = useCallback(async () => {
    ...
    try {
      ...
      formData.append('prompt', 'Generate UI HTML using Tailwind CSS based on this image. Provide only the HTML code without any surrounding content.');

//this code is working great with backend openai  and codeeditor  and should match codeeditor 
"use client";
...
const Webllix: React.FC = () => {
  ...
  const SendImage = useCallback(async () => {
    ...
    try {
      ...
      router.push(`/homepage/codeeditor?code=${encodeURIComponent(data.result)}`);
    } catch (error) {

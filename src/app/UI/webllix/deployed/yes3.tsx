...
///its displaying iamge id and sending to openia generatign code bas ehtisiamge sometime work sometime not  but difretn image id   and not dispalying iamg in code 
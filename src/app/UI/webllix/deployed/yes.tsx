...
const Webllix: React.FC = () => {
  ...
  const fetchAndSetSelectedImage = async (imageId: string) => {
    try {
      ...
      setSelectedImageId(imageId); // Store the selected image ID
    } catch (error) {
...
///in this its not dispalying url is dispalying user id  and generating code redirecting aslo  but same id 